...
class MongoDBOperation:
    ...
    def get_database(self, db_name) -> Database:
        ...
        Description :   This method gets database from MongoDB cluster as per the db_name
    ...
    def insert_dataframe_as_record(self, data_frame, db_name, collection_name) -> None:
        ...
        Description :This method inserts the dataframe as record in database collection(pd dataframe want to insert in database)
